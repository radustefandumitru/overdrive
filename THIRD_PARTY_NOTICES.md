...
| Impeccable by Paul Bakaus / @pbakaus | https://github.com/pbakaus/impeccable | Apache-2.0 | Installed from approved upstream path, pinned to verified `skill-v3.1.1` commit for v0.5 |
| React Doctor by Million / Aiden Bai / @aidenybai | https://github.com/millionco/react-doctor | MIT | Installed from approved upstream path for `react-doctor` |
...
| Boris Cherny / Anthropic prompt-line principles, shared by @AnatoliKopadze | https://x.com/AnatoliKopadze | Public talk/social reference, not redistributed | The concise/objective/research-first global prompt lines are paraphrased behavioral guidance; no raw talk transcript or post text is vendored. |
...
| Gabrielle Merite / @gabriell_lab and Baptiste Briel / @baptistebriel | Public design/motion references | Reference only | Logged for possible v0.6 proximity-pattern research; no source text, assets, or code are vendored. |
| Mannu / @mannupaaji | Public scroll-state reference | Reference only | Logged for possible v0.6 scroll-state research; no source text, assets, or code are vendored. |
