...
| GSD / get-shit-done | https://github.com/gsd-build/get-shit-done | MIT | Installed/updated through the official `get-shit-done-cc@latest` npm installer |
...
| Playwright CLI | https://github.com/microsoft/playwright-cli | Apache-2.0 | Installed/updated through the official `@playwright/cli@latest` skill installer |
...
If you publish `bundled/skills`, make sure you are comfortable redistributing those files and preserving any required license notices. A private zip shared with a teammate is lower risk than a public repo that republishes every bundled skill.
