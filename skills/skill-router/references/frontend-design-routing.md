...
- Liquid Glass Web: original local AgenticSupercharge skill inspired by Andrew Prifer's liquid-dom work, kube.io's CSS/SVG Liquid Glass technique, and optional license-checked WebGL libraries such as https://github.com/naughtyduk/liquidGL. Do not vendor third-party code without license review.
