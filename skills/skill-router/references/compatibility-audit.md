...
| Convert to Markdown | Local document conversion before reading PDFs, Office files, spreadsheets, HTML exports, CSV/data, or knowledge-vault docs | Yes; original local skill | AS-Workflow knowledge vault, `defuddle` for web pages | Uses MarkItDown when available; cannot intercept native model file ingestion and must not overwrite originals |
