...
function commitEdit(rootDir, rawEntries, opts = {}) {
  ...
  lines.push('');
  // DOC UPDATE hook stub (Q3.6.8 — minimal; full impl deferred to Phase 7)
  lines.push('Recommend: /ovd-workflow refresh to update codebase mapping if EDIT touched documented surfaces.');
