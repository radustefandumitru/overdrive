...
const runCodebaseMap = codebaseMapperModule.runCodebaseMap;
...
const runRequirementsDraft = requirementsDraftModule.runRequirementsDraft;
...
function runWorkflowInit(rootDir, opts = {}) {
  ...
  const canonical = {
    mapping: {
      runner: (root) => runCodebaseMap(root, {}),
      logKey: 'codebase-map',
      next: 'preferences',
    ...
    requirements: {
      runner: (root) => runRequirementsDraft(root, {}),
